 ...
 * A candidate is considered unique by comparing using {@code Candidate#isSameCandidate(Candidate)}.
 * As such, adding and updating of candidates uses Candidate#isSameCandidate(Candidate) for equality so as to ensure
 * that the candidate being added or updated is unique in terms of identity in the UniqueCandidateList. However, the
 * removal of a candidate uses Candidate#equals(Object) so
